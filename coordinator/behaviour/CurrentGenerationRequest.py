...
class CurrentGenerationRequest(OneShotBehaviour):

  async def on_start(self):
    #print("{} - [{}] - Starting CurrentGenerationRequest . . .".format(datetime.now(), self.agent.name))
    pass
  ...
  async def run(self):
    ...
    if os.path.isfile(filepath):
      ...
      msg.thread = "current-generation-request"
      msg.body = content
  ...
  async def on_end(self):
    print("{} - [{}] - Ending CurrentGenerationRequest . . .".format(datetime.now(), self.agent.name))